...
Stop hunting for variable names in `_variables.scss`. Stop digging through deep theme objects. Token Flow indexes your whole Design System and makes token usage **fluid, fast and error-proof**.
...
- TS/JS preset objects (PrimeUIX, Style-Dictionary aliases…)
